...
{
	u8 tget;
	tget=Read_Ds1302_Byte(0x81);
	pREDtime[2]=tget/16 *10+tget%16;
	tget=Read_Ds1302_Byte(0x83);
	pREDtime[1]=tget/16 *10+tget%16;
	tget=Read_Ds1302_Byte(0x85);
	pREDtime[0]=tget/16 *10+tget%16;
}